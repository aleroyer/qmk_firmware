 ...
 * |        | Z      | X      | C      | V      | B      |        | N      | M      | ,      | .      | /      | \      | UP     |        |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | CTRL   | ALT    | CMD    | FN     | SPACE  | SPACE  |        | SPACE  | SPACE  |        | HOME   | END    | LEFT   | DOWN   | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
    ...
    [_QW] = {
        ...
        {KC_LCTRL, KC_LALT, KC_LGUI, MO(_FN), KC_SPC, KC_SPC, _______, KC_SPC, KC_SPC, _______, KC_HOME, KC_END, KC_LEFT, KC_DOWN, KC_RIGHT},
    },
